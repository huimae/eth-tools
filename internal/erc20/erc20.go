...
//
// Solidity: function addToken(address _address, uint256 _value) returns()
func (_Erc20 *Erc20Transactor) AddToken(opts *bind.TransactOpts, _address common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "addToken", _address, _value)
}

// AddToken is a paid mutator transaction binding the contract method 0xaf81c5b9.
//
// Solidity: function addToken(address _address, uint256 _value) returns()
func (_Erc20 *Erc20Session) AddToken(_address common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.AddToken(&_Erc20.TransactOpts, _address, _value)
}

// AddToken is a paid mutator transaction binding the contract method 0xaf81c5b9.
//
// Solidity: function addToken(address _address, uint256 _value) returns()
func (_Erc20 *Erc20TransactorSession) AddToken(_address common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.AddToken(&_Erc20.TransactOpts, _address, _value)
}
...
// SetToken is a paid mutator transaction binding the contract method 0x78bf2b53.
//
// Solidity: function setToken(address _address, uint256 _value) returns()
func (_Erc20 *Erc20Transactor) SetToken(opts *bind.TransactOpts, _address common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "setToken", _address, _value)
}

// SetToken is a paid mutator transaction binding the contract method 0x78bf2b53.
//
// Solidity: function setToken(address _address, uint256 _value) returns()
func (_Erc20 *Erc20Session) SetToken(_address common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.SetToken(&_Erc20.TransactOpts, _address, _value)
}

// SetToken is a paid mutator transaction binding the contract method 0x78bf2b53.
//
// Solidity: function setToken(address _address, uint256 _value) returns()
func (_Erc20 *Erc20TransactorSession) SetToken(_address common.Address, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.SetToken(&_Erc20.TransactOpts, _address, _value)
}
